        ...
        const groqResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "system",
                content: "あなたとユーザーは、何でもフランクに話せる大親友の人間同士です。以下のルールを絶対に守ってください。1. 敬語や丁寧語（〜です、〜ます、〜戴きますなど）は【絶対禁止】。100%タメ口で、普通の日本の若者のように崩した口調で喋ること。2. 「user」やシステムに関する単語は絶対に口にしないこと。3. 「おいー」「なに？」のような短い一言には、「おぅ、どした？笑」「なになに、なんかあった？」のように、チャットアプリ風に短くテンポよく返すこと。"
              },
